...
return this.y+=a.size.outerHeight,{x:b,y:c}},b.prototype._getContainerSize=function(){return{height:this.y}},b}"function"==typeof define&&define.amd?define("isotope/js/layout-modes/vertical",["../layout-mode"],b):b(a.Isotope.LayoutMode)}(window),jQuery(document).ready(function(a){var b=a("#isotope-container .isotope");b.isotope({filter:"*",layoutMode:"fitRows",animationOptions:{duration:750,easing:"linear",queue:!1}}),a(".filters a").click(function(){var c=a(this).attr("data-filter");return a(".filters a").each(function(){a(this).removeClass("is-checked")}),a(this).addClass("is-checked"),b.isotope({filter:c,layoutMode:"fitRows",animationOptions:{duration:750,easing:"linear",queue:!1}}),!1})}),$=jQuery,jQuery(document).ready(function(a){a("#responsive-tabs").responsiveTabs({startCollapsed:"accordion",animation:"fade",animationQueue:"tabs",scrollToAccordion:!0,duration:300}),new WOW({mobile:!1}).init()});var mainApp={};mainApp.grabType=function(){var a=$("#design-case.services-case-studies").data("cases"),b=$("#maintenance-case.services-case-studies").data("cases"),c=$("#consulting-case.services-case-studies").data("cases"),d=$("#artinstallations-case.services-case-studies").data("cases");console.log(a),mainApp.grabDesign=function(a){$.ajax({url:"http://ecoman.dev/wp-json/wp/v2/case_study?filter[taxonomy]=service&filter[term]="+a,success:function(b){console.log(b),mainApp.printProjectInfo(b,a)},cache:!1})},mainApp.grabMain=function(a){$.ajax({url:"http://ecoman.dev/wp-json/wp/v2/case_study?filter[taxonomy]=service&filter[term]="+a,success:function(b){console.log(b),mainApp.printProjectInfo(b,a)},cache:!1})},mainApp.grabConsult=function(a){$.ajax({url:"http://ecoman.dev/wp-json/wp/v2/case_study?filter[taxonomy]=service&filter[term]="+a,success:function(b){console.log(b),mainApp.printProjectInfo(b,a)},cache:!1})},mainApp.grabAI=function(a){$.ajax({url:"http://ecoman.dev/wp-json/wp/v2/case_study?filter[taxonomy]=service&filter[term]="+a,success:function(b){console.log(b),mainApp.printProjectInfo(b,a)},cache:!1})},mainApp.printProjectInfo=function(a,b){var c=$("<p>",{"class":"project__static-intro",html:"A project we loved working on:"}),d=$("<h1>",{"class":"project__dimension",html:a[0].title.rendered}),e=a[0].content.rendered;"design"==b?$("#design-case.services-case-studies .outer-container .main-content-case-study").append(d,e):"maintenance"==b?$("#maintenance-case.services-case-studies .outer-container .main-content-case-study").append(d,e):"consulting"==b?$("#consulting-case.services-case-studies .outer-container .main-content-case-study").append(d,e):$("#artinstallations-case.services-case-studies .outer-container .main-content-case-study").append(c,d,e)},mainApp.grabDesign(a),mainApp.grabMain(b),mainApp.grabConsult(c),mainApp.grabAI(d)},window.onload=function(){console.log("ready!"),mainApp.grabType()};
